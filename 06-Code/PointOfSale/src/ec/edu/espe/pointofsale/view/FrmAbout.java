...
public class FrmAbout extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("The POMPEI bakery records all its movements in the accounting \nfiles of its business to maintain quality control regarding \nfinances and its products, by workers so that they have a \nrecord in the system of products, sales, user that can choose \nyour products easily and provides you with an invoice");
